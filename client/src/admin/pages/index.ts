...
export const LoadAdminNewsPreview = lazy(
  () => import("./news/AdminNewsPreview"),
);
...
export const LoadAdminNewStudents = lazy(
  () => import("../../common/pages/newstudent/NewStudents"),
);
export const LoadAdminRoom = lazy(() => import("./rooms/AdminRoom"));
export const LoadAdminRoomId = lazy(() => import("./rooms/AdminRoomId"));
export const LoadAdminReception = lazy(
  () => import("./reception/AdminReception"),
);
export const LoadAdminHome = lazy(() => import("./AdminHome"));
export const LoadAttendancePage = lazy(
